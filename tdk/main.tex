...
The project was made possible by the support of the European Union and the cofounding of the European Social Fund (EFOP-3.6.3-VEKOP-16-2017-00001)
\usetikzlibrary{backgrounds,calc}
\begin{tikzpicture}[remember picture,overlay]
  \begin{pgfonlayer}{background}
    \node[anchor=south east,outer sep=0pt,inner sep=0pt] at (current page.south east) {\includegraphics[width=12cm]{figures/efop_logo.png}};
  \end{pgfonlayer}
\end{tikzpicture}
