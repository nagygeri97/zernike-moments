...
In practice, this algorithm calculates the roots of $P_n$ with accuracy up to machine precision in only a just a few, predefined number of iterations for both the Runge-Kutta and the Newton's method.
