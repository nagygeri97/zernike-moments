...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \large Date of closing: 1 December 2020
  \end{center}
\end{titlepage}
...
\begin{tikzpicture}[remember picture,overlay]
  \begin{pgfonlayer}{background}
    \node[anchor=south east,outer sep=0pt,inner sep=0pt] at (current page.south east) {\includegraphics[width=11cm]{figures/efop_logo_en.jpg}};
  \end{pgfonlayer}
\end{tikzpicture}
